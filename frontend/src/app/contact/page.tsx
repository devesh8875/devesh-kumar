...
import { Facebook, Twitter, Pinterest, Instagram, Youtube } from 'lucide-react';
            ...
            <div className="relative z-10">
              ...
              <div className="flex items-center gap-4">
                <a href="#" className="w-10 h-10 bg-white rounded-full flex items-center justify-center text-[#ff4a1c] hover:scale-110 transition-transform">
                  <Facebook size={18} fill="currentColor" className="border-0" />
                </a>
                <a href="#" className="w-10 h-10 bg-white rounded-full flex items-center justify-center text-[#ff4a1c] hover:scale-110 transition-transform">
                  <Twitter size={18} fill="currentColor" className="border-0" />
                </a>
                <a href="#" className="w-10 h-10 bg-white rounded-full flex items-center justify-center text-[#ff4a1c] hover:scale-110 transition-transform">
                  <Pinterest size={18} fill="currentColor" className="border-0" />
                </a>
                <a href="#" className="w-10 h-10 bg-white rounded-full flex items-center justify-center text-[#ff4a1c] hover:scale-110 transition-transform">
                  <Instagram size={18} />
                </a>
                <a href="#" className="w-10 h-10 bg-white rounded-full flex items-center justify-center text-[#ff4a1c] hover:scale-110 transition-transform">
                  <Youtube size={18} fill="currentColor" className="border-0" />
                </a>
              </div>
            </div>
          </div>
